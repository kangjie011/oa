...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript">
      ...
      function test(obj){
    	    if (obj.value == '1'){
    	        document.getElementById("u48_input").name = "person_yuyuetime1";
    	    } else if(obj.value == '2'){
    	        document.getElementById("u48_input").name = "person_liushi";
    	    }
    	}
    </script>
  </head>
  <body>
  <form action="${pageContext.request.contextPath }/addpersonjbxx">
    <div id="base" class="">
      ...
      <div id="u10" class="ax_default text_field">
        <input id="u10_input" type="text" name="person_postion" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u11" class="ax_default text_field">
        <input id="u11_input" type="text" name="person_name" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u12" class="ax_default text_field">
        <input id="u12_input" type="text" name="person_political" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u13" class="ax_default text_field">
        <input id="u13_input" type="text" name="person_birthday" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u14" class="ax_default text_field">
        <input id="u14_input" type="text" name="person_phone" value=""/>
      </div>
      ...
      <div id="u21" class="ax_default text_field">
        <input id="u21_input" type="text" name="person_sex" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u22" class="ax_default text_field">
        <input id="u22_input" type="text" name="person_marital" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u23" class="ax_default text_field">
        <input id="u23_input" type="text" name="person_idcard" value=""/>
      </div>
     ...
     <!-- Unnamed (文本框) -->
      <div id="u32" class="ax_default text_field">
        <input id="u32_input" type="text" name="person_email" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u33" class="ax_default text_field">
        <input id="u33_input" type="text" name="person_exceptesalary" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u34" class="ax_default text_field">
        <input id="u34_input" type="text" name="person_nation" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u35" class="ax_default text_field">
        <input id="u35_input" type="text" name="person_stature" value=""/>
      </div>
     ...
     <!-- Unnamed (文本框) -->
      <div id="u40" class="ax_default text_field">
        <input id="u40_input" type="text" name="person_age" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u41" class="ax_default text_field">
        <input id="u41_input" type="text" name="person_health" value=""/>
      </div>
      ...
      <div id="u44" class="ax_default html_button">
        <input id="u44_input" type="submit" value="提交"/>
      </div>
      ...
      <div id="u47" class="ax_default droplist">
        <select id="u47_input" style="font-size:24px" onchange="test(this);">
        <option>请选择</option>
...
<!--         <input id="u48_input" type="text" name="" value=""/> -->
      <input id="u48_input" onclick="WdatePicker()" type="text" name="" />
      </div>
      ...
      <div id="u51" class="ax_default text_field">
        <input id="u51_input" type="text" name="person_yuyuetime2" onclick="WdatePicker()" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u52" class="ax_default text_field">
        <input id="u52_input" type="text" name="person_beizhu" value=""/>
      </div>
    </div>
    </form>
  </body>
