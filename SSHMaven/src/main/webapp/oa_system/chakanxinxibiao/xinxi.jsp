...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
<%--   <form action="${pageContext.request.contextPath }/adddengjibiao"> --%>
    <div id="base" class="">
      ...
      <div id="u14" class="ax_default text_field">
        <input id="u14_input" type="text" name="person_postion" value="${person.person_postion }"/>
      </div>
      ...
      <div id="u17" class="ax_default text_field">
        <input id="u17_input" type="text" name="person_exceptesalary" value="${person.person_exceptesalary }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u18" class="ax_default text_field">
        <input id="u18_input" type="text" name="person_name" value="${person.person_name }"/>
      </div>
      ...
      <div id="u21" class="ax_default text_field">
        <input id="u21_input" type="text" name="person_sex" value="${person.person_sex }"/>
      </div>
      ...
      <div id="u24" class="ax_default text_field">
        <input id="u24_input" type="text" name="person_age" value="${person.person_age }"/>
      </div>
      ...
      <div id="u27" class="ax_default text_field">
        <input id="u27_input" type="text" name="person_nation" value="${person.person_nation }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u28" class="ax_default text_field">
        <input id="u28_input" type="text" name="person_political" value="${person.person_political }"/>
      </div>
      ...
      <div id="u31" class="ax_default text_field">
        <input id="u31_input" type="text" name="person_stature" value="${person.person_stature }"/>
      </div>
      ...
      <div id="u34" class="ax_default text_field">
        <input id="u34_input" type="text" name="person_marital" value="${person.person_marital }"/>
      </div>
      ...
      <div id="u37" class="ax_default text_field">
        <input id="u37_input" type="text" name="person_health" value="${person.person_health }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u38" class="ax_default text_field">
        <input id="u38_input" type="text" name="person_birthday" value="${person.person_birthday }"/>
      </div>
      ...
      <div id="u41" class="ax_default text_field">
        <input id="u41_input" type="text" name="person_idcard" value="${person.person_idcard }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u42" class="ax_default text_field">
        <input id="u42_input" type="text" name="person_ncre" value="${person.person_ncre }"/>
      </div>
      ...
      <div id="u45" class="ax_default text_field">
        <input id="u45_input" type="text" name="person_cre" value="${person.person_cre }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u46" class="ax_default text_field">
        <input id="u46_input" type="text" name="person_emergency" value="${person.person_emergency }"/>
      </div>
      ...
      <div id="u49" class="ax_default text_field">
        <input id="u49_input" type="email" name="person_email" value="${person.person_email }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u50" class="ax_default text_field">
        <input id="u50_input" type="text" name="person_phone" value="${person.person_phone }"/>
      </div>
      ...
      <div id="u63" class="ax_default text_field">
        <input id="u63_input" type="text" name="person_hukou" value="${person.person_hukou }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u64" class="ax_default text_field">
        <input id="u64_input" type="text" name="person_address" value="${person.person_address }"/>
      </div>
      ...
      <div id="u72" class="ax_default text_field">
        <input id="u72_input" type="text" name="person_comingdate" value="${person.person_comingdate }"/>
      </div>
      ...
      <div id="u77" class="ax_default text_field">
        <input id="u77_input" type="text" name="person_eb1statdate" value="${person.person_eb1statdate }"/>
      </div>
      ...
      <div id="u80" class="ax_default text_field">
        <input id="u80_input" type="text" name="person_eb1school" value="${person.person_eb1school }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u81" class="ax_default text_field">
        <input id="u81_input" type="text" name="person_eb1specialty" value="${person.person_eb1specialty }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u82" class="ax_default text_field">
        <input id="u82_input" type="text" name="person_eb2statdate" value="${person.person_eb2statdate }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u83" class="ax_default text_field">
        <input id="u83_input" type="text" name="person_eb2school" value="${person.person_eb2school }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u84" class="ax_default text_field">
        <input id="u84_input" type="text" name="person_eb2specialty" value="${person.person_eb2specialty }"/>
      </div>
      ...
      <div id="u97" class="ax_default text_field">
        <input id="u97_input" type="text" name="person_wh1date" value="${person.person_wh1date }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u98" class="ax_default text_field">
        <input id="u98_input" type="text" name="person_wh2date" value="${person.person_wh2date }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u99" class="ax_default text_field">
        <input id="u99_input" type="text" name="person_wh3date" value="${person.person_wh3date }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u100" class="ax_default text_field">
        <input id="u100_input" type="text" name="person_wh1company" value="${person.person_wh1company }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u101" class="ax_default text_field">
        <input id="u101_input" type="text" name="person_wh2company" value="${person.person_wh2company }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u102" class="ax_default text_field">
        <input id="u102_input" type="text" name="person_wh3company" value="${person.person_wh3company }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u103" class="ax_default text_field">
        <input id="u103_input" type="text" name="person_wh1job" value="${person.person_wh1job }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u104" class="ax_default text_field">
        <input id="u104_input" type="text" name="person_wh2job" value="${person.person_wh2job }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u105" class="ax_default text_field">
        <input id="u105_input" type="text" name="person_wh3job" value="${person.person_wh3job }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u106" class="ax_default text_field">
        <input id="u106_input" type="text" name="person_wh1leavereason" value="${person.person_wh1leavereason }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u107" class="ax_default text_field">
        <input id="u107_input" type="text" name="person_wh2leavereason" value="${person.person_wh2leavereason}"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u108" class="ax_default text_field">
        <input id="u108_input" type="text" name="person_wh3leavereason" value="${person.person_wh3leavereason }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u109" class="ax_default text_field">
        <input id="u109_input" type="text" name="person_wh1ms" value="${person.person_wh1ms }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u110" class="ax_default text_field">
        <input id="u110_input" type="text" name="person_wh2ms" value="${person.person_wh2ms }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u111" class="ax_default text_field">
        <input id="u111_input" type="text" name="person_wh3ms" value="${person.person_wh3ms }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u112" class="ax_default text_field">
        <input id="u112_input" type="text" name="person_wh1reterorphone" value="${person.person_wh1reterorphone }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u113" class="ax_default text_field">
        <input id="u113_input" type="text" name="person_wh2reterorphone" value="${person.person_wh2reterorphone }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u114" class="ax_default text_field">
        <input id="u114_input" type="text" name="person_wh3reterorphone" value="${person.person_wh3reterorphone }"/>
      </div>
      ...
      <div id="u127" class="ax_default text_field">
        <input id="u127_input" type="text" name="person_familyname1" value="${person.person_familyname1 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u128" class="ax_default text_field">
        <input id="u128_input" type="text" name="person_familyname2" value="${person.person_familyname2 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u129" class="ax_default text_field">
        <input id="u129_input" type="text" name="person_familyrelation1" value="${person.person_familyrelation1 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u130" class="ax_default text_field">
        <input id="u130_input" type="text" name="person_familyrelation2" value="${person.person_familyrelation2 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u131" class="ax_default text_field">
        <input id="u131_input" type="text" name="person_familyage1" value="${person.person_familyage1 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u132" class="ax_default text_field">
        <input id="u132_input" type="text" name="person_familyage2" value="${person.person_familyage2 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u133" class="ax_default text_field">
        <input id="u133_input" type="text" name="person_familycompany1" value="${person.person_familycompany1 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u134" class="ax_default text_field">
        <input id="u134_input" type="text" name="person_familycompany2" value="${person.person_familycompany2 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u135" class="ax_default text_field">
        <input id="u135_input" type="text" name="person_familyjob1" value="${person.person_familyjob1 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u136" class="ax_default text_field">
        <input id="u136_input" type="text" name="person_familyjob2" value="${person.person_familyjob2 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u137" class="ax_default text_field">
        <input id="u137_input" type="text" name="person_familyphone1" value="${person.person_familyphone1 }"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u138" class="ax_default text_field">
        <input id="u138_input" type="text" name="person_familyphone2" value="${person.person_familyphone2 }"/>
      </div>
...
<%--         <input type="text" name="person_id" hidden = "hidden" value="${personId }" /> --%>
<!--       </div> -->
